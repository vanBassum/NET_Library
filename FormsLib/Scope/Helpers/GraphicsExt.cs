...
namespace FormsLib.Scope.Helpers
{
    ...
    //    {
    //        g.Drawpoint(brush, pt.X, pt.Y, size);
    //    }
    ...
    //            rect.X += 2;
    //            rect.Width -= 4;
    //            g.DrawFitTextToRectangle(p, viewPort, rect, text, font);
    //        }
    //        else
    //        {
    //            if (rect.X > viewPort.X + viewPort.Width)
